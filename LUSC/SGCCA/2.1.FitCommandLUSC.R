setwd("C:/Users/migue/workspace/LUSC")

argms=commandArgs(trailingOnly = T)

penalty_cpgs <- as.numeric(argms[1])
penalty_transcripts <- as.numeric(argms[2])
penalty_mir <- as.numeric(argms[3])
...
subtype <- readMtrx("subtypeLUSC.tsv")
...
sizes = c(basal=13, classical=27, normal=3, primitive=10, secretory=22)
...
# [1] "basal"     "classical" "normal"    "primitive" "secretory" 
...
setwd("C:/Users/migue/workspace/LUSC/Penalties")
