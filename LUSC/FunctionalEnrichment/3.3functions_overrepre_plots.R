...
KEGG <- list(
  ...
  primitive = c("hsa03040", "hsa04141", "hsa04144", "hsa04213", "hsa04612", "hsa04915", "hsa05020", "hsa05134", "hsa05145", "hsa05162", "hsa05417"),
  secretory = c("hsa00220", "hsa00250", "hsa01210")
)

# Data frame it 
tabla <- data.frame(V1 = character(), V2 = character(), stringsAsFactors = FALSE)

for (nombre in names(KEGG)) {
  valores <- KEGG[[nombre]]
  tabla <- rbind(tabla, data.frame(V1 = rep(nombre, length(valores)), V2 = valores, stringsAsFactors = FALSE))
}
...
BP.classes=as.data.frame(do.call(rbind,lapply(1:4,
...
bias(KEGG.classes,1,3)
#character(0)
i=bias(BP.classes,3,4)
#[1] "developmental process" "response to stimulus"  
