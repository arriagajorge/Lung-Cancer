...
files=list.files("/home/jvasquez/Documents/Lung-Cancer/LUAD",full.names=T)
...
names(data)=gsub("/home/jvasquez/Documents/Lung-Cancer/LUAD/","",files)
names(data)=gsub(".eigenNormi","",names(data))
# "methyM"           "miRNAseqNormi"    "RNAseqnormalized"
...
write.table(data_[[2]],paste(names(data_)[2],"mtrx",sep='.'),sep='\t',quote=F)
write.table(data_[[3]],paste(names(data_)[3],"mtrx",sep='.'),sep='\t',quote=F)