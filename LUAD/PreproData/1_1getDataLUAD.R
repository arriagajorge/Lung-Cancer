...
samples_2<-samples[which(!samples$patient%in%subtypes$patient[   #samples_2 is only a name to dont overwrite
...
write.table(samples_,"subtypeLUAD.tsv",sep='\t',quote=F,row.names=F)
