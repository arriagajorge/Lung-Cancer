#!/usr/bin/env Rscript
setwd("/home/jvasquez/Documents/3_SGCCA/sort")
########################PARAMETERS & PACKAGES
...
library(biomaRt)
methy=read_tsv("/home/jvasquez/Documents/3_SGCCA/MapMethy.tsv",show_col_types=F)
...
tfs=read_tsv("/home/jvasquez/Documents/3_SGCCA/TFtargets.tsv",show_col_types=F)
...
if(length(grep("hsa",features))>0){
  ...
  mirIDs=read_tsv("/home/jvasquez/Documents/3_SGCCA/miRNA.tsv")
